...
export declare function getClassName(baseProps: BaseProps): string | undefined;
...
export default function BaseComponent({ component, id, fragmentIndex, children, ...props }: Props): import("react").DetailedReactHTMLElement<{
    'data-id': string | undefined;
    id: string | undefined;
    className: string | undefined;
    'data-fragment-index': number | undefined;
